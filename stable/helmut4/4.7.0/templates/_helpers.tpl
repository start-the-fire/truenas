...
{{printf "--spring.data.mongodb.host=%s-mongodb" .Values.appname}}
{{printf "--spring.data.mongodb.port=%s" (.Values.mongodbSettings.port | toString)}}
{{printf "--spring.data.mongodb.username=%s"  .Values.mongodbSettings.username }}
{{printf "--spring.data.mongodb.password=%s"  .Values.mongodbSettings.password }}
{{printf "--spring.data.mongodb.authentication-database=admin" }}
